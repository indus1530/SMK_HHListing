package edu.aku.hassannaqvi.smk_hhlisting_app.activities.sync;
...
import edu.aku.hassannaqvi.smk_hhlisting_app.adapters.SyncListAdapter;
...
public class SyncActivity extends AppCompatActivity implements SyncDevice.SyncDevicInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPref = getSharedPreferences("listingHHSMK", MODE_PRIVATE);
