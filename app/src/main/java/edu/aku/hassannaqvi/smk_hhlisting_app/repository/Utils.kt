...
fun dbBackup(context: Context) {
    ...
    if (sharedPref.getBoolean("flag", false)) {
        val dt: String = sharedPref.getString("dt", SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(Date())).toString()
        ...
        var folder = File(Environment.getExternalStorageState().toString() + File.separator + DatabaseHelper.PROJECT_NAME)
        var success = true
        if (!folder.exists()) {
